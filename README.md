...
**Note: Modeling, Model Evaluation, visualization, and other detailed findings related to customer segmentation clustering can be accessed in the [customer_segmentation_clustering](LINK) Notebook.**
